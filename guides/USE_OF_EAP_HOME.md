...
The developer guides and quickstart README files use the *replaceable* value `EAP_HOME` to denote the path to the JBoss EAP 6 installation. When you encounter this value in a README file or guide, be sure to replace it with the actual path to your JBoss EAP 6 installation. 
