...
* If you used the {JBDSProductName} installer to install and configure the WildFly Server, the default path for `__WILDFLY_HOME__` is `${user.home}/jbdevstudio/runtimes/jboss-eap`.
